...
describe('Table HostComponent', () => {
    ...
    describe('Table grouping-tree mode', () => {
        ...
        it('should change from grouping to tree mode correctly', () => {
            component.addGroup('FirstName');
            tools.clickSelectAllBox();

            expect(component.selected.length).toBe(2);

            const changeHandler = jasmine.createSpy('event');
            smartTable.addEventListener('change', changeHandler);
