...
describe('Table HostComponent', () => {
    ...
    describe('Table grouping-tree mode', () => {
        ...
        it('should change from grouping to tree mode correctly', fakeAsync(() => {
            ...
            component.dataSourceSettings = {
                ...
                id: 'EmployeeID',
                dataFields: [
                    { name: 'EmployeeID', dataType: 'number' },
                    { name: 'ReportsTo', dataType: 'number' },
            ...
            const leafCells = smartTable.querySelectorAll('td.tree-leaf');

            expect(leafCells.length).toBeGreaterThan(0);
        }));

        it('should change from tree mode to grouping correctly', async () => {
            component.grouping = false;
            component.dataSourceSettings = {
                keyDataField: 'EmployeeID',
                parentDataField: 'ReportsTo',
            ...
            component.dataSourceSettings.id = '';
            component.dataSourceSettings.keyDataField = '';
            component.dataSourceSettings.parentDataField = '';
            component.dataSourceSettings.dataFields = [];

            component.grouping = true;
            component.dataSource = data;
            component.addGroup('FirstName');

            const groupedCells = smartTable.querySelectorAll('td.group-header');
