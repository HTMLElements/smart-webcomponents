...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    columns = [
        ...
        { label: 'Last Name', dataField: 'lastName', dataType: 'string', allowRowGroup: true, rowGroup: true, align: 'right' },
        { label: 'Product Name', dataField: 'productName', dataType: 'string', allowPivot: true, pivot: true, align: 'center' },
        { label: 'Quantity', dataField: 'quantity', dataType: 'number', summary: 'sum', align: 'right', summarySettings: { align: 'right' } },
        {
            label: 'Price', dataField: 'price', dataType: 'number', summary: 'sum',
            summarySettings: {
                align: 'left',
                prefix: '€',
                decimalPlaces: 2,
