...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    dataSource = [
        { label: 'שם פרטי', dataField: 'firstName', icon: 'firstName', dataType: 'string' },
        { label: 'שם משפחה', dataField: 'lastName', icon: 'lastName', dataType: 'string' },
        { label: 'יום הולדת', dataField: 'birthday', icon: 'birthday', dataType: 'date' },
        { label: 'שם חיית המחמד', dataField: 'petName', icon: 'petName', dataType: 'string' },
        { label: 'מדינה', dataField: 'country', icon: 'country', dataType: 'string' },
        { label: 'שם מוצר', dataField: 'productName', icon: 'productName', dataType: 'string' },
        { label: 'מחיר', dataField: 'price', icon: 'price', dataType: 'number' },
        { label: 'כמות', dataField: 'quantity', icon: 'quantity', dataType: 'number' },
        { label: 'זמן הרכישה', dataField: 'timeOfPurchase', icon: 'timeOfPurchase', dataType: 'date' },
        { label: 'לא בתוקף', dataField: 'expired', icon: 'expired', dataType: 'boolean' }
    ];
    operator = 'or';
    value = [
