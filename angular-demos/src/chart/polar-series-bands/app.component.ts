...
import { ChartComponent, ChartType, ChartXAxis, ChartColorScheme } from 'smart-webcomponents-angular/chart';
...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    init(): void {
        ...
        for (let i = 0; i < that.recessions.length; i++) {
            bands[i] = { minValue: that.recessions[i].from, maxValue: that.recessions[i].to, fillColor: 'red', opacity: 0.2 };
        }

        that.xAxis.bands = bands;
