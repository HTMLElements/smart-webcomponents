...
import { SchedulerComponent, SchedulerEvent, SchedulerGroupOrientation, SchedulerResource, SchedulerViews, SchedulerViewType } from 'smart-webcomponents-angular/scheduler';
