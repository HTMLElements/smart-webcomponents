...
import { SchedulerComponent, SchedulerEvent, SchedulerGroupOrientation, SchedulerResource, SchedulerViews } from 'smart-webcomponents-angular/scheduler';
