...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    @ViewChild('testimonialsContainer', { read: ElementRef, static: false }) testimonialsContainer: ElementRef;
    ...
    init(): void {
        ...
        function scrollFunction() {
            const aboutContainer = that.aboutContainer.nativeElement,
                ...
                testimonialsContainer = that.testimonialsContainer.nativeElement,
                ...
                if (!ticking) {
                    window.requestAnimationFrame(function () {
                        const windowScrollPosition = Math.round(last_known_scroll_position),
                            testimonialsContainerOffsetTop = Math.round(testimonialsContainer.offsetTop) - 100,
                        ...
                        if (windowScrollPosition) {
                            ...
                            else if (pricingContainerOffsetTop <= windowScrollPosition && windowScrollPosition < testimonialsContainerOffsetTop) {
                                pricingContainerMenuItem.classList.add('active-item');
                            }
                            else if (testimonialsContainerOffsetTop <= windowScrollPosition && windowScrollPosition < contactsContainerOffsetTop) {
