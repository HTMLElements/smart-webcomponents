...
import { CheckBox } from 'smart-webcomponents-angular/checkbox';
...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    private dataSource1: Array<object> = [
    ...
    private dataSource2: Array<object> = [
    ...
    private dataSource3: Array<object> = [
    ...
    onRowDetailInit: Function = function (index: number, row: any, detail: HTMLElement) {
                ...
                case 'completed':
                    {
                        ...
                        const value: CheckBox = document.createElement('smart-check-box');
                        value.readonly = true;
                ...
                case 'logo':
                    {
                        ...
                        const value: HTMLImageElement = document.createElement('img');
    ...
    grid2Columns: Array<object> = [
        ...
        { label: 'Completed', width: '25%', dataField: 'completed', template: 'checkBox', allowResize: true },
        {
            ...
            template: function (formatObject: any): void {
                ...
                formatObject.template = '<span class="person-template"><img src="./../../../src/images/phonebook/' + image + '.png"><div>' + formatObject.value + '</div></span>';
            }
        },
        {
    ...
    init(): void {
        ...
        const that = this,
            grid1: GridComponent = that.grid,
            grid2: GridComponent = that.grid2,
            grid3: GridComponent = that.grid3,
            tabs: TabsComponent = that.tabs,
            tabStrip: HTMLDivElement = that.tabsContainer.nativeElement,
            recordsSpan: HTMLSpanElement = document.createElement('span');
