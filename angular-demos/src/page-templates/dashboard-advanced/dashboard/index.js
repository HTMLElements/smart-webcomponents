...
function loadDashboardJs() {
        ...
        columns: [
            {
                ...
                template: function (formatObject) {
                    ...
                    if (!formatObject.template) {
                        formatObject.template = '<smart-check-box class="tasks-today" ' + checkboxChecked + ' ></smart-check-box>';
                    }
                    else {
            ...
            },
            {
                ...
                template: function (formatObject) {
                    if (!formatObject.template) {
                        formatObject.template = '<div><i class="material-icons">' + formatObject.value + '</i></div>';
                    }
                }
            },
        ]
    ...
    // Management Table
    const usersImages = [
        '../../../images/girl-2771001_960_720.jpg',
        '../../../images/man-4252192_960_720.jpg',
        '../../../images/girl-2366438_960_720.jpg',
        '../../../images/entrepreneur-593358_960_720.jpg',
        '../../../images/woman-3096664_960_720.jpg'
    ];
        ...
        columns: [
            {
                ...
                template: function (formatObject) {
                    if (!formatObject.template) {
                        formatObject.template = '<img class="user-image" src = "' + formatObject.value + '" />';
                    }
                }
            },
            ...
            { label: 'Job position', dataField: 'position', cellsAlign: 'center', align: 'center', width: '15%' },
            {
                ...
                template: function (formatObject) {
                    if (!formatObject.template) {
                        formatObject.template = '<div class="progress-bar-holder"><smart-progress-bar value="' + formatObject.value + '"></smart-progress-bar></div>';
                    }
                }
            },
            { label: 'Salary', dataField: 'salary', width: '20%', cellsAlign: 'center', align: 'center' },
            {
                ...
                template: function (formatObject) {
                    if (!formatObject.template) {
                        formatObject.template = '<i class="material-icons refresh-icon">refresh</i>&nbsp;<i class="material-icons close-icon">close</i>';
                    }
                }
            }
        ]
