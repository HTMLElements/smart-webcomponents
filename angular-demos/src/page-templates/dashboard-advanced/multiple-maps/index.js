(function () {
    'use strict'
    applyThemeMultipleMaps();
    initMultipleMaps();
})();

function applyThemeMultipleMaps() {
...
function initMultipleMaps() {
    ...
    var uluru = { lat: -18.887503, lng: 47.442474 };
    let styles = [
        {
    ...
    var map = new google.maps.Map(
        document.getElementById('gmap1'), { zoom: 4, center: uluru, styles: styles });
    ...
    map = new google.maps.Map(
        document.getElementById('gmap2'), { zoom: 4, center: uluru, styles: styles });
    // The marker, positioned at Uluru
    ...
    // The map, centered at Uluru
    map = new google.maps.Map(
        document.getElementById('gmap3'), { zoom: 6, center: uluru, styles: styles });
    // The marker, positioned at Uluru
    marker = new google.maps.Marker({ position: uluru, map: map });
}
