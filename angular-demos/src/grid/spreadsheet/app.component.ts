...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    columns = [
        { label: 'A', dataField: 'A', align: 'center', width: 100 },
        { label: 'B', dataField: 'B', align: 'center', width: 100 },
        { label: 'C', dataField: 'C', align: 'center', width: 100 },
        { label: 'D', dataField: 'D', align: 'center', width: 100 },
        { label: 'E', dataField: 'E', align: 'center', width: 100 },
        { label: 'F', dataField: 'F', align: 'center', width: 100 },
        { label: 'G', dataField: 'G', align: 'center', width: 100 },
        { label: 'H', dataField: 'H', align: 'center', width: 100 },
        { label: 'I', dataField: 'I', align: 'center', width: 100 },
        { label: 'J', dataField: 'J', align: 'center', width: 100 },
        { label: 'K', dataField: 'K', align: 'center', width: 100 },
        { label: 'L', dataField: 'L', align: 'center', width: 100 },
        { label: 'M', dataField: 'M', align: 'center', width: 100 },
        { label: 'N', dataField: 'N', align: 'center', width: 100 },
        { label: 'O', dataField: 'O', align: 'center', width: 100 },
        { label: 'P', dataField: 'P', align: 'center', width: 100 },
        { label: 'Q', dataField: 'Q', align: 'center', width: 100 },
        { label: 'R', dataField: 'R', align: 'center', width: 100 },
        { label: 'S', dataField: 'S', align: 'center', width: 100 },
        { label: 'T', dataField: 'T', align: 'center', width: 100 },
        { label: 'U', dataField: 'U', align: 'center', width: 100 },
        { label: 'V', dataField: 'V', align: 'center', width: 100 },
        { label: 'W', dataField: 'W', align: 'center', width: 100 },
        { label: 'X', dataField: 'X', align: 'center', width: 100 },
        { label: 'Y', dataField: 'Y', align: 'center', width: 100 },
        { label: 'Z', dataField: 'Z', align: 'center', width: 100 }
    ]
