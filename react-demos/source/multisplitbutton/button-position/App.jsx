...
class App extends React.Component {
	constructor(p) {
		...
		this.multisplitbutton = React.createRef();
	}

	handleChange(position) {
		this.multisplitbutton.current.dropDownButtonPosition = position;
	}
		...
		return (
			<div>
				<div id="comboBoxContainer">
					<MultiSplitButton ref={this.multisplitbutton} buttonsDataSource={['Send', 'Save', 'Save As']}>
					...
					<div className="options">
						...
						<div className="option">
							...
							<RadioButton onChange={this.handleChange.bind(this, 'right')} checked>Right</RadioButton>
						</div>
					</div>
				</div>
			</div>
