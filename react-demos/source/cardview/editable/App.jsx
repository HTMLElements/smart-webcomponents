...
class App extends React.Component {
	...
	render() {
		return (
			<div>
				<div className="demo-description">This example shows the editing feature of the CardView. You can also add
			        new cards by clicking the "+" button.</div>
				<p><em>Click a card to edit its data.</em>
				</p>
