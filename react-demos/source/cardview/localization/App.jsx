...
class App extends React.Component {
	...
	handleEnChange() {
		this.cardview.current.locale = 'en';
	}

	handleBgChange() {
		this.cardview.current.locale = 'bg';
	}
		...
		return (
			<div>
				<div className="options">Choose locale:
			        <div>
						<RadioButton id="en" checked onChange={this.handleEnChange.bind(this)}>English (en)</RadioButton>
						<RadioButton id="bg" onChange={this.handleBgChange.bind(this)}>Bulgarian (bg)</RadioButton>
					</div>
				</div>
