...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <div class="demo-description">Kanban with custom fields.</div>
        <Kanban id="kanban"
        collapsible={this.collapsible} dataSource={this.dataSource} dataSourceMap={this.dataSourceMap} 
        taskDue={this.taskDue} taskCustomFields={this.taskCustomFields}  taskProgress={this.taskProgress} columns={this.columns}
        dialogRendered={this.dialogRendered} localizeFormatFunction={this.localizeFormatFunction} users={this.users}  
        >
        </Kanban>
      </div>
    );
