  ...
  render() {
    return (
      <div>
        ...
        In this example the dialogCustomizationFunction is used to customize the built-in Kanban window.
        </div>
        <Kanban
         collapsible={this.collapsible} 
          addNewButton={this.addNewButton} editable={this.editable} columnActions={this.columnActions} columnEditMode={this.columnEditMode}
           ...
           dialogCustomizationFunction={this.dialogCustomizationFunction} users={this.users}>
        </Kanban>
      </div>
    );
  }
