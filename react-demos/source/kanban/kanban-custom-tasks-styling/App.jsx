	...
	render() {
		return (
			<div>
				...
				<Kanban
                    collapsible={this.collapsible} editable={this.editable} allowColumnReorder={this.allowColumnReorder}
                    allowColumnEdit={this.allowColumnEdit} allowColumnResize={this.allowColumnResize}
                    columnFooter={this.columnFooter} columnSummary={this.columnSummary}
                    columns={this.columns} onTaskRender={this.onTaskRender} dialogRendered={this.dialogRendered} localizeFormatFunction={this.localizeFormatFunction}
                    dataSource={this.dataSource} dataSourceMap={this.dataSourceMap} users={this.users} taskProgress={this.taskProgress}
				>
				</Kanban>
			</div>
		);
