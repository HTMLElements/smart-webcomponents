...
class App extends React.Component {
	...
	init() {
		...
		template.innerHTML = `<div className="custom-resource-panel-header">
								<div className="treeHeader" id="treeHeaderTemplateContainer">
									<label>Resources Type:</label>
								</div>
								<div className="timelineHeader" id="timelineHeaderTemplateContainer"></div>
							</div>`;
	...
	render() {
		return (
			<div>
				...
				<GanttChart ref={this.ganttchart} id="ganttChart" onReady={this.handleReady.bind(this)} dataSource={this.dataSource} treeSize={this.treeSize}
					taskPanelSize={this.taskPanelSize} durationUnit={this.durationUnit} view={this.view} selectedIndexes={this.selectedIndexes}
