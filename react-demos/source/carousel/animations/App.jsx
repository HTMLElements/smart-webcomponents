...
class App extends React.Component {
	...
	render() {
		return (
			<div>
				<Carousel dataSource={this.dataSource} autoPlay slideShow interval={2000} loop></Carousel>
				<Carousel dataSource={this.dataSource} className="fade" autoPlay slideShow
					interval={2000} loop></Carousel>
				<Carousel dataSource={this.dataSource} className="slide" autoPlay slideShow
					interval={2000} loop></Carousel>
				<Carousel dataSource={this.dataSource} className="slide-right" autoPlay slideShow
					interval={2000} loop></Carousel>
				<Carousel dataSource={this.dataSource} className="slide-top" autoPlay slideShow
					interval={2000} loop></Carousel>
				<Carousel dataSource={this.dataSource} className="slide-bottom" autoPlay slideShow
					interval={2000} loop></Carousel>
			</div>
		);
	}
