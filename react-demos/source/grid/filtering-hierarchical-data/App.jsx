...
class App extends React.Component {
	...
	filtering = {
		enabled: true,
		filter: [
			['FirstName', 'contains Michael or contains Nancy']
		]
	};
	behavior = {
	...
	render() {
		return (
			<div>
				<div className="demo-description">DataGrid supports Filtering of hierarchical data. When a child element
				...
				or 'Nancy'. As 'Michael' and 'Nancy' are sub-records of 'Andrew' and 'Steven',
			        they are displayed in the view.</div>
				<Grid id="grid"
