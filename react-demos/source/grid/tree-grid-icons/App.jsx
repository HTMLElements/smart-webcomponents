...
class App extends React.Component {
	...
	columns = [{
		...
		showIcon: true,
		formatFunction(args) {
			args.template = '<div><span className="custom-icon fa-user"></span>' + args.value + '</div>';
		}
	},
	{
		label: 'Last Name',
	...
	render() {
		return (
			<div>
				<div className="demo-description">The Tree Grid can display icons in the cells by using the column's formatFunction.</div>
				<Grid id="grid"
