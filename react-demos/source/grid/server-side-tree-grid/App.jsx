		...
		return (
			<div>
			    <div className="demo-description">
			        	<h1>Server-side Tree Grid</h1>Datagrid in this example is used as a Tree Grid. That is achieved by setting
			        the dataSource's 'keyDataField' and 'parentDataField' properties. When
			        a row is expanded the datagrid sends a request with the expanded row data
			        ...
			        used.</div>
			    <Grid ref="grid" dataSource={this.dataSource} columns={this.columns} sorting={this.sorting} appearance={this.appearance} filtering={this.filtering} id="grid"></Grid>
			    <br />
			    <br />
			    	<h3>SQL Query</h3>
			    <div id="query"></div>
