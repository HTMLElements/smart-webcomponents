...
class App extends React.Component {
	...
	handleRadioButtonChange(mode, event) {
		this.textbox.current.displayMode = mode;
	}
	...
	render() {
		return (
			<div>
			    <TextBox ref={this.textbox} placeholder="Your text" minLength={1}>
			    ...
			    className="options">
			        ...
			        <div className="option">
			            <RadioButton  id="defaultMode" checked onChange={this.handleRadioButtonChange.bind(this, 'default')}>Default mode</RadioButton>
			            <RadioButton  id="escapedMode" onChange={this.handleRadioButtonChange.bind(this, 'escaped')}>Escaped mode</RadioButton>
			            <br />
			        </div>
			</div>
			</div>
