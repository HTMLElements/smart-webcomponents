...
class App extends React.Component {
	...
	saveState() {
		this.scheduler.current.saveState();
	}

	loadState() {
		this.scheduler.current.loadState();
	}
			...
			<div>
				...
				<div className="options">
					...
					<div className="option">
						<Button ref="button" id="saveState" onClick={this.saveState.bind(this)}>Save State</Button>
					</div>
					<div className="option">
						<Button ref="button2" id="loadState" onClick={this.loadState.bind(this)}>Load State</Button>
					</div>
					<div className="option">
						<Button ref="button3" id="clearState" onClick={this.clearState.bind(this)}>Reset</Button>
					</div>
				</div>
			</div>
		);
