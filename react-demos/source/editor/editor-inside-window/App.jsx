...
class App extends React.Component {
	...
	handleClick() {
		const popupWindow = this.popupWindow.current;
		
		popupWindow.opened ? popupWindow.close() : popupWindow.open();
	}

	componentDidMount() {
		this.popupWindow.current.open();
	}

	render() {
		return (
			<div>
			    <Window ref={this.popupWindow} id="popupWindow" label="Window Editor">
			        <Editor id="editor">
			             <h3>
...
The following demo showcases most of the Smart Editor Methods. Clicking
			        ...
			        <div class="option">
			            <Button id="openWindow" onClick={this.handleClick.bind(this)}>Toggle Window</Button>
			        </div>
			    </div>
			</div>
		);
