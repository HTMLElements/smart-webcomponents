...
class App extends React.Component {
	...
	autoSaveInterval = 500; //The interval in miliseconds
	...
	render() {
		return (
			<div>
				<Editor ref={this.editor} id="editor" autoSave={this.autoSave} autoLoad={this.autoLoad} autoSaveInterval={this.autoSaveInterval}>
					<h1 style={{ textAlign: 'center' }}><a href="https://en.wikipedia.org/wiki/Sozopol">Sozopol</a></h1>
					<p><b>Sozopol&nbsp;</b><u>(Bulgarian:&nbsp;Созопол&nbsp;[soˈzɔpoɫ],&nbsp;Greek:&nbsp;Σωζόπολη,
          ...
          <br />
				...
				<div class="options">
					...
					<div class="option">
						<CheckBox id="autoSaveState" checked onChange={this.handleEvent.bind(this, 'autoSave')}>Auto Save State</CheckBox>
						<CheckBox id="autoLoadState" onChange={this.handleEvent.bind(this, 'autoLoad')}
							checked>Auto Load State</CheckBox>
					</div>
					<div class="option">
						<Button id="saveState" onClick={this.handleEvent.bind(this, 'save')}>Save</Button>
						<Button id="loadState" onClick={this.handleEvent.bind(this, 'load')}>Load</Button>
						<Button id="deleteState" onClick={this.handleEvent.bind(this, 'delete')}>Delete</Button>
					</div>
				</div>
			</div>
		);
