...
class App extends React.Component {
	...
	render() {
		return (
			<div>
				<Editor ref={this.editor} id="editor" contextMenuDataSource={this.contextMenuDataSource} onContextMenuItemClick={this.handleContextMenuItemClick.bind(this)}>
