...
class App extends React.Component {
	...
	handleChange(event) {
		this.editor.current.previewMode(event.detail.value);
	}
			...
			<div>
				...
				<div className="options">
					...
					<div className="option">
						...
						<SwitchButton ref={this.switchbutton} id="switchButton" onChange={this.handleChange.bind(this)}>Show HTML Output</SwitchButton>
					</div>
				</div>
			</div>
		);
