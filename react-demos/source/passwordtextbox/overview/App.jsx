			...
			<div>
			    <div className="smart-demo-container">
			        <section>
			            <div>
			                ...
			                <div className="module">
			                    <p>Password Text fields typically reside in forms but can appear in other
			        ...
			        <section id="text-box-principles">
			            ...
			            <div className="module">
			                 <h2>Identifiable</h2>
			                <p>Using a tappable touch target, password text fields should indicate that
			                    users can enter information.</p>
			                 <h3>Findable</h3>
			                <p>It should be easy to find a password text field among other elements.</p>
			                 <h3>Legible</h3>
			                <p>Password Text fields should indicate their state – whether enabled or
			                    disabled, empty or filled, valid or invalid – with clear label, input,
			                    and assistive text.</p>
			            </div>
			        </section>
			        <section id="text-box-layout">
			            ...
			            <br />
			             <h3>Label</h3>
			            <p>Password Text field labels display the type of input a field requires.
			            ...
			            <div>
			                <div className="module">
			                    ...
			                    <br />
			                    <PasswordTextBox  disabled></PasswordTextBox>
			                    <p>Disabled</p>
