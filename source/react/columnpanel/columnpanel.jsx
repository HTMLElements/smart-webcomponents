...
*/
export class ColumnPanel extends React.Component {
	// Gets the id of the React component.
	get id() {
		if (!this._id) {
			this._id =  'ColumnPanel' + Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
		}
	...
	*  @param event. The custom event. 	*/
	...
	render() {
		return (
			React.createElement("smart-column-panel", { ref: this.componentRef }, this.props.children)
		)
	}
}
