...
*/
export class TabLayoutItem extends React.Component<React.HTMLAttributes<Element> & TabLayoutItemProps, any> {   
	private _id: string;
	...
	*  @param event. The custom event. 	*/
	...
	render() {
		return (
			React.createElement("smart-tab-layout-item", { ref: this.componentRef }, this.props.children)
		)
	}
}
