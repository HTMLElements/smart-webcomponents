...
*/
export class TabLayoutGroup extends React.Component<React.HTMLAttributes<Element> & TabLayoutGroupProps, any> {   
	private _id: string;
	...
	*  @param event. The custom event. 	*/
	...
	render() {
		return (
			React.createElement("smart-tab-layout-group", { ref: this.componentRef }, this.props.children)
		)
	}
}
