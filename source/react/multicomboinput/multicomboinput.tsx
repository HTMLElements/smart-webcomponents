...
*/
export class MultiComboInput extends React.Component<React.HTMLAttributes<Element> & MultiComboInputProps, any> {   
	private _id: string;
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-multi-combo-input", { ref: this.componentRef }, this.props.children)
		)
	}
}
