...
import { Animation, DropDownButtonPosition, MultiComboInputQueryMode, MultiComboInputInputTagsMode, ElementRenderMode} from './../index';
...
export class MultiComboInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
	constructor(ref: ElementRef<MultiComboInput>) {
		super(ref);
		this.nativeElement = ref.nativeElement as MultiComboInput;
	}

	private eventHandlers: any[] = [];

	public nativeElement: MultiComboInput;
	/** @description Creates the component on demand.
	 * @param properties An optional object of properties, which will be added to the template binded ones.
	 */
	public createComponent(properties = {}): any {
    	this.nativeElement = <MultiComboInput>document.createElement('smart-multi-combo-input');
	...
	@Input()
	get queryMode(): MultiComboInputQueryMode {
		return this.nativeElement ? this.nativeElement.queryMode : undefined;
	}
	set queryMode(value: MultiComboInputQueryMode) {
	...
	@Input()
	get inputTagsMode(): MultiComboInputInputTagsMode {
		return this.nativeElement ? this.nativeElement.inputTagsMode : undefined;
	}
	set inputTagsMode(value: MultiComboInputInputTagsMode) {
