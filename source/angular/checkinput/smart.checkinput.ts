...
import { Animation, DropDownButtonPosition, CheckInputQueryMode, ElementRenderMode} from './../index';
...
export class CheckInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
	constructor(ref: ElementRef<CheckInput>) {
		super(ref);
		this.nativeElement = ref.nativeElement as CheckInput;
	}

	private eventHandlers: any[] = [];

	public nativeElement: CheckInput;
	/** @description Creates the component on demand.
	 * @param properties An optional object of properties, which will be added to the template binded ones.
	 */
	public createComponent(properties = {}): any {
    	this.nativeElement = <CheckInput>document.createElement('smart-check-input');
