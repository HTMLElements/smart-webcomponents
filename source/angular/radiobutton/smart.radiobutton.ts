...
export class RadioButtonComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
	constructor(ref: ElementRef<RadioButton>) {
		super(ref);
		this.nativeElement = ref.nativeElement as RadioButton;
	}

	private eventHandlers: any[] = [];

	public nativeElement: RadioButton;
	/** @description Creates the component on demand.
	 * @param properties An optional object of properties, which will be added to the template binded ones.
	 */
	public createComponent(properties = {}): any {
    	this.nativeElement = <RadioButton>document.createElement('smart-radio-button');
