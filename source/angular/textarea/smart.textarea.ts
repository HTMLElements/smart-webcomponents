...
import { Animation, DropDownButtonPosition, TextAreaQueryMode, ElementRenderMode} from './../index';
import { Component, Directive, AfterViewInit, ElementRef, Input, OnInit, OnChanges, OnDestroy, SimpleChanges, forwardRef, ChangeDetectionStrategy, Output, EventEmitter } from '@angular/core';
import { BaseElement, Smart } from './smart.element';
export { Animation, DropDownButtonPosition, TextAreaQueryMode, ElementRenderMode} from './../index';
...
export class TextAreaComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
	constructor(ref: ElementRef<TextArea>) {
		super(ref);
		this.nativeElement = ref.nativeElement as TextArea;
	}

	private eventHandlers: any[] = [];

	public nativeElement: TextArea;
	/** @description Creates the component on demand.
	 * @param properties An optional object of properties, which will be added to the template binded ones.
	 */
	public createComponent(properties = {}): any {
    	this.nativeElement = <TextArea>document.createElement('smart-text-area');
