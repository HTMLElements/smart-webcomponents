  ...
  <div class="vue-root">
    ...
    <div class="options">
      <div class="description">
        <h4>Choose the orientation for Agenda view:</h4>
      </div>
      <div class="option">
        <smart-radio-button checked>Horizontal</smart-radio-button>
        <smart-radio-button>Vertical</smart-radio-button>
      </div>
    </div>
  </div>
</template>
    ...
    onMounted(() => {
      ...
      document
        ...
        .addEventListener("change", function (event) {
          ...
          scheduler.groupOrientation = target.textContent.trim().toLowerCase();
        });
    });
  },
};
