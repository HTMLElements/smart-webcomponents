  ...
  <div class="vue-root">
    ...
    <div class="options">
      <div class="description">
        ...
        <ul>
          <li>
            classic - the events are fitted inside the target cell. No event
            collector is used.
          </li>
          <li>
            modern - the events are fitted according to their size set via the
            CSS variable. Events that overflow will be placed inside a
            collector. On Mobile all events are placed inside collectors.
          </li>
        </ul>
      </div>
      <div class="option">
    ...
    onMounted(() => {
      ...
      document
        ...
        .addEventListener("change", function (event) {
          scheduler.eventRenderMode = event.target.value;
        });
    });
  },
};
