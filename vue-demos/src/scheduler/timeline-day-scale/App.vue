  ...
  <div class="vue-root">
    ...
    <div class="options">
      <div class="description">
        <h4>Description</h4>
        <b>timelineDayScale</b> determines the scale of a day cell. By default a
        day cell represents one day, but it can be splitted into half am hour,
        quarter hour, ten minutes or five minutes.
      </div>
      <div class="option">
    ...
    onMounted(() => {
      ...
      document
        ...
        .addEventListener("change", function (event) {
          scheduler.timelineDayScale = event.target.value;
        });
    });
  },
};
