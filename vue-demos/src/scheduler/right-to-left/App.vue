          ...
          get properties() {
            return {
              ...
              messages: {
                he: {
                  invalidValue:
                    "{{elementType}}: ערך {{property}} לא חוקי. {{property}} צריך להיות מסוג {{typeOne}} או {{typeTwo}}.",
                  invalidTimeZone:
                    "{{elementType}}: ערך timeZone לא חוקי. TimeZone צריך להיות ממסד הנתונים של אזור הזמן של IANA.",
                  incorrectArgument:
                    "{{elementType}}: טיעון שגוי {{argumentName}} בשיטה {{methodName}}.",
                  noId:
                    "smartScheduler דורש מזהה על מנת לשמור / לטעון / לנקות מצב.",
                  agenda: "סֵדֶר הַיוֹם",
                  day: "יְוֹם",
                  week: "שָׁבוּעַ",
                  month: "חוֹדֶשׁ",
                  ...
                  yearly: "שְׁנָתִי",
                  repeatConfirm:
                    "האם אתה רוצה לערוך רק את האירוע הנוכחי או את כל הסדרה?",
