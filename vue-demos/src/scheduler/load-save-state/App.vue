<template>
  <div class="vue-root">
    ...
    <div class="options">
      <div class="option">
        <b>Save State</b> Button saves the current state of the Scheduler to
        LocalStorage. <b>Load State</b> Button reloads a previously saved state.
        <b>Reset</b> Button will erase any cache and will restore the Scheduler
        to it's initial state.
        <p>
          Previously saved states of the element are pre-loade on page refresh.
        </p>
        <p>
          Notice that the element must have an 'id' in order to save/load it's
          state.
        </p>
      </div>
      <div class="option">
...
export default {
  ...
  setup() {
    onMounted(() => {
      ...
      const scheduler = this.document.querySelector("smart-scheduler");
