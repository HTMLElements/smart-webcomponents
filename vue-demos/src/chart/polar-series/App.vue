      ...
      <table>
        ...
        <tr>
          <td>
            ...
            <smart-drop-down-list id="dropDownSeries" selection-mode="one" selected-indexes="[0]"></smart-drop-down-list>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          <td>
            ...
            <smart-drop-down-list id="dropDownColors" selection-mode="one" selected-indexes="[0]"></smart-drop-down-list>
          </td>
        </tr>
      </table>
    </div>
      ...
      window.Smart(
        ...
        class {
          get properties() {
            return {
              caption:
                "U.S. Real Home Price vs Building Cost Indeces (1950-2010)",
