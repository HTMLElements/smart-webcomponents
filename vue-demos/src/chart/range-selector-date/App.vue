<template>
  <div class="vue-root">
    ...
    <br />
    <div class="options">
      <smart-check-box id="renderTo">Render to external div</smart-check-box>
    </div>
    <br />
...
<b>Daily volume:</b> ${dataItem.Volume}
      ...
      document
        ...
        .addEventListener("change", function(event) {
          ...
          if (!chart.xAxis.rangeSelector) {
            return;
          }
          if (event.detail.value) {
            chart.xAxis.rangeSelector.renderTo = document.getElementById(
              "selectorContainer"
            );
          } else {
            chart.xAxis.rangeSelector.renderTo = null;
          }
        });
    });
  }
