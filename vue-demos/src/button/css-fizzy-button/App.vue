<template>
  <div class="vue-root">
    <div class="button-demo css-fizzy-button">
        ...
        <div class="button">
          ...
          <label for="button">
            <div class="button_inner q">
              <smart-button class="smart-button">
...
smart-button {
  ...
  --smart-button-background-active: transparent;
  --smart-button-background-focus: transparent;
...
smart-button:focus,
smart-button button:focus,
smart-button:active,
smart-button button:active,
smart-button:focus,
smart-button button:focus {
...
input:checked + label .button_inner {
  ...
  -webkit-animation: finalbox 0.4s 4.42s cubic-bezier(0.39, 2.01, 0.27, 0.75)
    forwards;
...
input:checked + label .button_spots:nth-of-type(0) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-0 0.7s 11.0571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-0 0.7s 11.0571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(1) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-1 0.7s 10.4444444444s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-1 0.7s 10.4444444444s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(2) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-2 0.7s 11s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-2 0.7s 11s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(3) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-3 0.7s 10.55s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-3 0.7s 10.55s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(4) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-4 0.7s 10.8571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-4 0.7s 10.8571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(5) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-5 0.7s 10.45s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-5 0.7s 10.45s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(6) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-6 0.7s 10.2333333333s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-6 0.7s 10.2333333333s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(7) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-7 0.7s 10.4571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-7 0.7s 10.4571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(8) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.85s linear infinite,
    final 0.2s 4s forwards, spot-8 0.7s 10.1666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.85s linear infinite,
    final 0.2s 4s forwards, spot-8 0.7s 10.1666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(9) {
  ...
  opacity: 0;
  padding: 6.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-9 0.7s 10.2s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-9 0.7s 10.2s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(10) {
  ...
  opacity: 0;
  padding: 5.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-10 0.7s 10.5333333333s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-10 0.7s 10.5333333333s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(11) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-11 0.7s 10.5666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-11 0.7s 10.5666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(12) {
  ...
  padding: 4px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-12 0.7s 10.88s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-12 0.7s 10.88s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(13) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-13 0.7s 10.6s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-13 0.7s 10.6s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(14) {
  ...
  padding: 2.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-14 0.7s 10.74s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-14 0.7s 10.74s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(15) {
  ...
  opacity: 0;
  padding: 4px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.85s linear infinite,
    final 0.2s 4s forwards, spot-15 0.7s 10.8s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.85s linear infinite,
    final 0.2s 4s forwards, spot-15 0.7s 10.8s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(16) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-16 0.7s 10.95s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-16 0.7s 10.95s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(17) {
  ...
  opacity: 0;
  padding: 4.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-17 0.7s 10.7s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-17 0.7s 10.7s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(18) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-18 0.7s 10.3s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-18 0.7s 10.3s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(19) {
  ...
  opacity: 0;
  padding: 5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-19 0.7s 10.8s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-19 0.7s 10.8s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(20) {
  ...
  opacity: 0;
  padding: 5.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-20 0.7s 10.24s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-20 0.7s 10.24s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(21) {
  ...
  padding: 3px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-21 0.7s 10.6666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-21 0.7s 10.6666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(22) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-22 0.7s 10.8333333333s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-22 0.7s 10.8333333333s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(23) {
  ...
  opacity: 0;
  padding: 4px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-23 0.7s 10.3571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-23 0.7s 10.3571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(24) {
  ...
  opacity: 0;
  padding: 2.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.05s linear infinite,
    final 0.2s 4s forwards, spot-24 0.7s 10.68s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.05s linear infinite,
    final 0.2s 4s forwards, spot-24 0.7s 10.68s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(25) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-25 0.7s 11.08s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-25 0.7s 11.08s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(26) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-26 0.7s 10.3666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-26 0.7s 10.3666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(27) {
  ...
  padding: 3.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-27 0.7s 10.6571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-27 0.7s 10.6571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(28) {
  ...
  padding: 5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-28 0.7s 10.44s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-28 0.7s 10.44s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(29) {
  ...
  opacity: 0;
  padding: 5.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-29 0.7s 11.3s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-29 0.7s 11.3s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(30) {
  ...
  padding: 5.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-30 0.7s 10.38s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-30 0.7s 10.38s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(31) {
  ...
  opacity: 0;
  padding: 6.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-31 0.7s 10.8s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-31 0.7s 10.8s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(32) {
  ...
  padding: 5.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-32 0.7s 10.78s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-32 0.7s 10.78s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(33) {
  ...
  opacity: 0;
  padding: 6.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-33 0.7s 10.9666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-33 0.7s 10.9666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(34) {
  ...
  padding: 4px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-34 0.7s 10.4666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-34 0.7s 10.4666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(35) {
  ...
  padding: 3.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-35 0.7s 10.7333333333s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-35 0.7s 10.7333333333s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(36) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-36 0.7s 10.34s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-36 0.7s 10.34s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(37) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-37 0.7s 10.78s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-37 0.7s 10.78s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(38) {
  ...
  opacity: 0;
  padding: 6.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-38 0.7s 10.9444444444s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-38 0.7s 10.9444444444s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(39) {
  ...
  padding: 5.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-39 0.7s 11s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-39 0.7s 11s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(40) {
  ...
  opacity: 0;
  padding: 4.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-40 0.7s 10.54s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-40 0.7s 10.54s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(41) {
  ...
  padding: 2.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-41 0.7s 10.6666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.45s linear infinite,
    final 0.2s 4s forwards, spot-41 0.7s 10.6666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(42) {
  ...
  opacity: 0;
  padding: 6.25px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-42 0.7s 11.2s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-42 0.7s 11.2s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(43) {
  ...
  padding: 4.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-43 0.7s 10.1571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.45s linear infinite,
    final 0.2s 4s forwards, spot-43 0.7s 10.1571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(44) {
  ...
  opacity: 0;
  padding: 2.25px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-44 0.7s 10.44s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-44 0.7s 10.44s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(45) {
  ...
  padding: 3.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-45 0.7s 10.4s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 1.35s linear infinite,
    final 0.2s 4s forwards, spot-45 0.7s 10.4s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(46) {
  ...
  padding: 6.25px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-46 0.7s 10.9571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-46 0.7s 10.9571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(47) {
  ...
  opacity: 0;
  padding: 4.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-47 0.7s 10.24s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-47 0.7s 10.24s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(48) {
  ...
  padding: 4.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-48 0.7s 10.98s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-48 0.7s 10.98s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(49) {
  ...
  padding: 3.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-49 0.7s 10.7666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-49 0.7s 10.7666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(50) {
  ...
  padding: 6px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-50 0.7s 10.2444444444s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 1.15s linear infinite,
    final 0.2s 4s forwards, spot-50 0.7s 10.2444444444s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(51) {
  ...
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-51 0.7s 11.05s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-51 0.7s 11.05s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(52) {
  ...
  padding: 4.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-52 0.7s 10.94s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-52 0.7s 10.94s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(53) {
  ...
  padding: 2.5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-53 0.7s 11.0571428571s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-53 0.7s 11.0571428571s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(54) {
  ...
  padding: 2.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-54 0.7s 10.38s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 1.25s linear infinite,
    final 0.2s 4s forwards, spot-54 0.7s 10.38s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(55) {
  ...
  padding: 4.25px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-55 0.7s 10.3666666667s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.35s linear infinite,
    final 0.2s 4s forwards, spot-55 0.7s 10.3666666667s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(56) {
  ...
  padding: 4.25px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.1s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-56 0.7s 10.94s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.1s 0.65s linear infinite,
    final 0.2s 4s forwards, spot-56 0.7s 10.94s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(57) {
  ...
  opacity: 0;
  padding: 5px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.2s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-57 0.7s 10.14s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.2s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-57 0.7s 10.14s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(58) {
  ...
  padding: 7px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-58 0.7s 10.6333333333s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.75s linear infinite,
    final 0.2s 4s forwards, spot-58 0.7s 10.6333333333s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(59) {
  ...
  padding: 3.75px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-59 0.7s 11.1s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.4s 0.55s linear infinite,
    final 0.2s 4s forwards, spot-59 0.7s 11.1s linear infinite !important;
}
...
input:checked + label .button_spots:nth-of-type(60) {
  ...
  opacity: 0;
  padding: 3px !important;
  -webkit-animation: spew 1s 0.3s forwards, rotate 4.3s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-60 0.7s 10.3s linear infinite !important;
  animation: spew 1s 0.3s forwards, rotate 4.3s 0.95s linear infinite,
    final 0.2s 4s forwards, spot-60 0.7s 10.3s linear infinite !important;
}
...
.button_inner:hover .button_spots:nth-of-type(1) {
  -webkit-animation: spot-1 0.7s 0.94s linear infinite;
  animation: spot-1 0.7s 0.94s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(2) {
  -webkit-animation: spot-2 0.7s 0.48s linear infinite;
  animation: spot-2 0.7s 0.48s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(3) {
  -webkit-animation: spot-3 0.7s 0.8s linear infinite;
  animation: spot-3 0.7s 0.8s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(5) {
  -webkit-animation: spot-5 0.7s 1.1333333333s linear infinite;
  animation: spot-5 0.7s 1.1333333333s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(6) {
  -webkit-animation: spot-6 0.7s 0.8666666667s linear infinite;
  animation: spot-6 0.7s 0.8666666667s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(8) {
  -webkit-animation: spot-8 0.7s 0.4s linear infinite;
  animation: spot-8 0.7s 0.4s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(9) {
  -webkit-animation: spot-9 0.7s 0.7s linear infinite;
  animation: spot-9 0.7s 0.7s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(10) {
  -webkit-animation: spot-10 0.7s 1.1s linear infinite;
  animation: spot-10 0.7s 1.1s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(11) {
  -webkit-animation: spot-11 0.7s 0.4s linear infinite;
  animation: spot-11 0.7s 0.4s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(12) {
  -webkit-animation: spot-12 0.7s 1.0666666667s linear infinite;
  animation: spot-12 0.7s 1.0666666667s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(13) {
  -webkit-animation: spot-13 0.7s 1.2s linear infinite;
  animation: spot-13 0.7s 1.2s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(14) {
  -webkit-animation: spot-14 0.7s 0.2666666667s linear infinite;
  animation: spot-14 0.7s 0.2666666667s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(16) {
  -webkit-animation: spot-16 0.7s 0.3666666667s linear infinite;
  animation: spot-16 0.7s 0.3666666667s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(17) {
  -webkit-animation: spot-17 0.7s 1.05s linear infinite;
  animation: spot-17 0.7s 1.05s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(18) {
  -webkit-animation: spot-18 0.7s 1.05s linear infinite;
  animation: spot-18 0.7s 1.05s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(19) {
  -webkit-animation: spot-19 0.7s 0.7444444444s linear infinite;
  animation: spot-19 0.7s 0.7444444444s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(20) {
  -webkit-animation: spot-20 0.7s 0.58s linear infinite;
  animation: spot-20 0.7s 0.58s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(22) {
  -webkit-animation: spot-22 0.7s 0.8s linear infinite;
  animation: spot-22 0.7s 0.8s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(23) {
  -webkit-animation: spot-23 0.7s 0.3333333333s linear infinite;
  animation: spot-23 0.7s 0.3333333333s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(24) {
  -webkit-animation: spot-24 0.7s 0.2444444444s linear infinite;
  animation: spot-24 0.7s 0.2444444444s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(25) {
  -webkit-animation: spot-25 0.7s 0.35s linear infinite;
  animation: spot-25 0.7s 0.35s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(26) {
  -webkit-animation: spot-26 0.7s 0.1571428571s linear infinite;
  animation: spot-26 0.7s 0.1571428571s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(27) {
  -webkit-animation: spot-27 0.7s 0.6666666667s linear infinite;
  animation: spot-27 0.7s 0.6666666667s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(28) {
  -webkit-animation: spot-28 0.7s 0.95s linear infinite;
  animation: spot-28 0.7s 0.95s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(29) {
  -webkit-animation: spot-29 0.7s 0.28s linear infinite;
  animation: spot-29 0.7s 0.28s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(30) {
  -webkit-animation: spot-30 0.7s 0.2s linear infinite;
  animation: spot-30 0.7s 0.2s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(31) {
  -webkit-animation: spot-31 0.7s 0.3666666667s linear infinite;
  animation: spot-31 0.7s 0.3666666667s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(32) {
  -webkit-animation: spot-32 0.7s 0.8571428571s linear infinite;
  animation: spot-32 0.7s 0.8571428571s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(33) {
  -webkit-animation: spot-33 0.7s 0.6s linear infinite;
  animation: spot-33 0.7s 0.6s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(34) {
  -webkit-animation: spot-34 0.7s 0.8333333333s linear infinite;
  animation: spot-34 0.7s 0.8333333333s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(35) {
  -webkit-animation: spot-35 0.7s 0.74s linear infinite;
  animation: spot-35 0.7s 0.74s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(36) {
  -webkit-animation: spot-36 0.7s 0.2666666667s linear infinite;
  animation: spot-36 0.7s 0.2666666667s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(37) {
  -webkit-animation: spot-37 0.7s 0.54s linear infinite;
  animation: spot-37 0.7s 0.54s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(38) {
  -webkit-animation: spot-38 0.7s 0.6571428571s linear infinite;
  animation: spot-38 0.7s 0.6571428571s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(39) {
  -webkit-animation: spot-39 0.7s 0.6333333333s linear infinite;
  animation: spot-39 0.7s 0.6333333333s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(40) {
  -webkit-animation: spot-40 0.7s 0.4s linear infinite;
  animation: spot-40 0.7s 0.4s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(41) {
  -webkit-animation: spot-41 0.7s 0.15s linear infinite;
  animation: spot-41 0.7s 0.15s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(42) {
  -webkit-animation: spot-42 0.7s 0.4333333333s linear infinite;
  animation: spot-42 0.7s 0.4333333333s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(43) {
  -webkit-animation: spot-43 0.7s 0.44s linear infinite;
  animation: spot-43 0.7s 0.44s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(44) {
  -webkit-animation: spot-44 0.7s 0.65s linear infinite;
  animation: spot-44 0.7s 0.65s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(45) {
  -webkit-animation: spot-45 0.7s 0.6333333333s linear infinite;
  animation: spot-45 0.7s 0.6333333333s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(46) {
  -webkit-animation: spot-46 0.7s 0.98s linear infinite;
  animation: spot-46 0.7s 0.98s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(47) {
  -webkit-animation: spot-47 0.7s 0.3444444444s linear infinite;
  animation: spot-47 0.7s 0.3444444444s linear infinite;
}
...
.button_inner:hover .button_spots:nth-of-type(49) {
  -webkit-animation: spot-49 0.7s 0.8s linear infinite;
  animation: spot-49 0.7s 0.8s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(50) {
  -webkit-animation: spot-50 0.7s 0.54s linear infinite;
  animation: spot-50 0.7s 0.54s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(51) {
  -webkit-animation: spot-51 0.7s 0.84s linear infinite;
  animation: spot-51 0.7s 0.84s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(52) {
  -webkit-animation: spot-52 0.7s 0.85s linear infinite;
  animation: spot-52 0.7s 0.85s linear infinite;
}

.button_inner:hover .button_spots:nth-of-type(53) {
  -webkit-animation: spot-53 0.7s 0.8s linear infinite;
  animation: spot-53 0.7s 0.8s linear infinite;
}
