    ...
    onMounted(() => {
      const sampleData = [
        ...
        },
        {
          ...
          Died: 1509,
          Bio:
            "Shen Zhou, courtesy name Qi'nan and Shitian, was a Chinese painter in the Ming dynasty.",
          Paintings:
            "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Poet_on_a_Mountaintop.jpg/800px-Poet_on_a_Mountaintop.jpg,https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Lofty_Mt.Lu_by_Shen_Zhou.jpg/304px-Lofty_Mt.Lu_by_Shen_Zhou.jpg"
        },
        {
          Name: "Ivan Milev",
          Country: "Bulgaria",
          ...
          Died: 1927,
          Bio:
            "Ivan Milev Lalev was a Bulgarian painter and scenographer regarded as the founder of the Bulgarian Secession and a representative of Bulgarian modernism, combining symbolism, Art Nouveau and expressionism in his work. Ivan Milev was born in the town of Kazanlak in the family of shepherd Milyu Lalev.",
          Paintings:
            "https://upload.wikimedia.org/wikipedia/commons/4/47/Svetogorska_legenda_1926.jpg,https://upload.wikimedia.org/wikipedia/commons/9/93/Ahinora_1922_%28Anna_Orozova_model%29.jpg"
        }
      ];
      window.Smart(
        "#cardView",
...
.born:after {
  background-image: url("https://img.icons8.com/ios/16/000000/babys-room-filled.png");
}

.died:after {
  background-image: url("https://img.icons8.com/ios/16/000000/cemetery-filled.png");
}

.bio:after {
  background-image: url("https://img.icons8.com/ios/16/000000/book-filled.png");
}
</style>
