<template>
  <div class="vue-root">
    <div class="options">
      <div class="caption">Select Header Buttons</div>
      <div class="option">
        <smart-button id="openButton">Open/Close</smart-button>
      </div>
      <div class="option">
        <smart-drop-down-list selection-mode="zeroOrMany">
          <smart-list-item value="close" selected>Close</smart-list-item>
          <smart-list-item value="collapse">Collapse</smart-list-item>
          <smart-list-item value="maximize" selected>Maximize</smart-list-item>
          <smart-list-item value="minimize" selected>Minimize</smart-list-item>
          <smart-list-item value="pin">Pin</smart-list-item>
        </smart-drop-down-list>
      </div>
    </div>
    <smart-window opened label="Window 1">
      <div id="article">
        <section>
...
export default {
  ...
  setup() {
    onMounted(() => {
      ...
      document
        .querySelector("smart-drop-down-list")
