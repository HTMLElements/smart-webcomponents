<template>
  <div class="vue-root">
    ...
    <div class="options">
        ...
        <smart-button id="dark-mode-button">Toggle Dark Mode</smart-button>
    </div>
  </div>
</template>
...
export default {
  ...
  setup() {
    onMounted(() => {
      ...
      chart.addColorScheme("customScheme", customColors);
      ...
      colorSchemes.addEventListener("change", function (event) {
        ...
        if (!useCustomScheme.checked) {
          chart.colorScheme = defaultScheme;
        }
      });
      ...
      document
        ...
        .addEventListener("change", function (event) {
          if (event.detail.value) {
            chart.colorScheme = "customScheme";
          } else {
            chart.colorScheme = defaultScheme;
          }
        });
