<template>
  <div class="vue-root">
    <div class="header">
      <div class="header">
        <div class="path">
          <span class="home">all files</span>
          <span class="active">source/</span>
        </div>
        <div class="coverage-info">
          <div class="statements">
            <span class="percantage">77.24%</span>
            <span class="text">Statements</span>
            <span class="overview">22470/29090</span>
          </div>
          <div class="branches">
            <span class="percantage">67.32%</span>
            <span class="text">Branches</span>
            <span class="overview">14637/21741</span>
          </div>
          <div class="functions">
            <span class="percantage">84.02%</span>
            <span class="text">Functions</span>
            <span class="overview">1992/2371</span>
          </div>
          <div class="functions">
            <span class="percantage">77.31%</span>
            <span class="text">Lines</span>
            <span class="overview">22372/28938</span>
          </div>
        </div>
...
export default {
  ...
  setup() {
    onMounted(() => {
              ...
              columns: [
                ...
                },
                {
                  ...
                  template: function(formatObject) {
                    ...
                    if (!formatObject.template) {
                      ...
                      progressBar.classList.add("statement-progress-bar");
                      progressBar.classList.add(progressBarColor);
                      progressBar.value = formatObject.value;
                      templateContainer.appendChild(progressBar);
                      formatObject.template = templateContainer;
                    } else {
                      formatObject.template.firstElementChild.value =
                        formatObject.value;
                      let progressBarClasses = formatObject.template.classList;
                      for (let i = 0; i < progressBarClasses.length; i++) {
                        if (
                          progressBarClasses[i] === "bkg-red" ||
                          progressBarClasses[i] === "bkg-yellow" ||
                          progressBarClasses[i] === "bkg-green"
                        ) {
                ...
                },
                {
                  ...
                  formatFunction(settings) {
                    setCellBackgroundColor(settings, 0, 4);
                  }
                },
                {
                  label: "",
                ...
                },
                {
                  ...
                  cellsAlign: "right",
                  formatFunction(settings) {
                    setCellBackgroundColor(settings, 5, 6);
                  }
                },
                {
                  label: "",
                ...
                },
                {
                  ...
                  cellsAlign: "right",
                  formatFunction(settings) {
                    setCellBackgroundColor(settings, 7, 8);
                  }
                },
                {
                  label: "",
                ...
                },
                {
                  ...
                  cellsAlign: "right",
                  formatFunction(settings) {
                    setCellBackgroundColor(settings, 9, 10);
                  }
                },
                {
                  label: "",
      ...
      function setCellBackgroundColor(settings, columnStart, columnEnd) {
        function bkgColor(v) {
          let cellColor;
          if (v < 50) {
            cellColor = "#FCE1E5";
...
:root {
  ...
  --smart-grid-row-height: 37px;
  --smart-grid-column-header-border: #bbb;
  --smart-grid-row-border: #bbb;
  --smart-grid-cell-color: rgb(51, 51, 51);
  /* Progress Bar */
  --smart-progress-bar-border-top-left-radius: 0;
  --smart-progress-bar-border-top-right-radius: 0;
  --smart-progress-bar-border-bottom-left-radius: 0;
  --smart-progress-bar-border-bottom-right-radius: 0;
}
...
smart-grid-cell[data-field="Statements_number"] .align-right {
  display: grid;
}
...
.coverage-info > div .percantage {
  font-weight: bold;
}

.coverage-info > div .text {
  color: rgba(0, 0, 0, 0.5);
}

.coverage-info > div .overview {
...
.coverage-info > div:not(.statements) {
  margin-left: 20px;
}
...
smart-progress-bar.bkg-red .smart-container {
  border-color: #c21f39;
}

smart-progress-bar.bkg-yellow .smart-container {
  border-color: #f9cd0b;
}

smart-progress-bar.bkg-green .smart-container {
  border-color: rgb(77, 146, 33);
}

smart-progress-bar.bkg-red .smart-value {
  background: #c21f39;
}

smart-progress-bar.bkg-yellow .smart-value {
  background: #f9cd0b;
}

smart-progress-bar.bkg-green .smart-value {
