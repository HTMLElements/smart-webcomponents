<template>
	<div class="vue-root">
		<div class="demo-description">
			...
			Datagrid filtering is switched on by using: 'filtering' property. When a data filter is applied in the datagrid a request with Filtering data object is made via 'virtualDataSource' on the Server-Side Datasource. The server
			uses the SQL query sent by the Server-Side Datasource to filter the rows.
			<br />
