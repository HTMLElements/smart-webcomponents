<template>
	<div class="vue-root">
		<div class="demo-description">
			...
			In this example, we use two Tables - 'Categories' and 'Products'. The master Grid displays the 'Categories' table. When a row from the 'Categories' table is expanded, a detail Grid with 'Products' matching the expanded 'CategoryID' is displayed in a popup
			dialog.
			<br />
...
smart-grid .smart-grid-row-detail {
	height: 300px;
}
