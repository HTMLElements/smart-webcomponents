<template>
  <div class="vue-root">
    <div class="demo-description">
      <h1>Grid Masked TextBox column type</h1>A MaskedTextBox Grid Column is intended for editing of strict input values
      such as SSN, Phone, Credit Card numbers, etc. Clicking on the "Phone" column
      cells will display a MaskedTextBox editor.
    </div>
