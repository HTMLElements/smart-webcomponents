<template>
  <div class="vue-root">
    ...
    >Grid CheckBox Selection. Checkbox is used for row selection in this demo.</div>
              ...
              columns: [
                {
                  ...
                  formatFunction(formatSettings) {
                    const firstName = formatSettings.value
                      .split(" ")[0]
                      .toLowerCase();
                    formatSettings.template =
                      '<div style="display: flex; align-items: center;"><img style="width: 24px; height: 24px; margin-right: 6px; border-radius: 50%;" class="logo" src="../../../images/phonebook/' +
                      firstName +
                      '.png"/>' +
...
smart-grid {
  ...
  --smart-grid-column-header-background-freeze: var(
    --smart-grid-cell-background
  );
}
