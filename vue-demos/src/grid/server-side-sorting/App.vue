<template>
	<div class="vue-root">
		<div class="demo-description">
			...
			Datagrid sorting is switched on by using: 'sorting' property. When a data sort is applied in the datagrid a request with Sorting data object is made via 'virtualDataSource' on the Server-Side Datasource. The server uses
			the SQL query sent by the Server-Side Datasource to sort the rows.
			<br />
