<template>
  <div class="vue-root">
    <div class="demo-description">
      <h1>Grid Email column type</h1>A column with email type stores a single email address in each cell. Clicking
      on an email address within an email field will open up your device's native
      email client with the To: field addressed to the email you just clicked
      on.
    </div>
                ...
                dataSource: [
                  {
                    ...
                    projectLeadEmail: "nancy@htmlelements.com",
                  ...
                  },
                  {
                    ...
                    projectLeadEmail: "anne@htmlelements.com",
                  ...
                  },
                  {
                    ...
                    projectLeadEmail: "mike@htmlelements.com",
                  ...
                  },
                  {
                    ...
                    projectLeadEmail: "bob@htmlelements.com",
                  ...
                  },
                  {
                    ...
                    projectLeadEmail: "andrew@htmlelements.com",
                  ...
                  },
                  {
                    ...
                    projectLeadEmail: "laura@htmlelements.com",
        ...
        Object.keys(row.data).forEach(key => {
          ...
          switch (key) {
            ...
            case "projectLeadEmail": {
              ...
              label.href = "mailto:" + row.data[key];
              element.appendChild(label);
              break;
            }
            case "category":
