<template>
  <div class="vue-root">
    <smart-drop-down-list selected-indexes="[0]" placeholder="Some text...">
...
<style>
smart-drop-down-list .smart-action-button {
  background: url(../../../node_modules/smart-webcomponents/source/styles/images/magnifier.png)
    no-repeat 98% 50%;
  background-size: 5%;
  padding-right: 8%;
}
