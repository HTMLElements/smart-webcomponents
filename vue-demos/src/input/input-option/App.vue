<template>
  <div class="vue-root">
    <div class="demo-description">
		The Input in this example is created from 'option' tags.
	</div>

	<smart-input drop-down-button-position="right">
...
import "smart-webcomponents/source/modules/smart.checkinput.js";
