<template>
  <div class="vue-root">
    <smart-splitter id="splitter">
      <smart-splitter-item size="25%" collapsible>
      ...
      <smart-splitter-item size="25%" collapsible>
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed lobortis
        ...
        <p>
          Vivamus placerat quam vel eros hendrerit, id sagittis eros suscipit. Cras
          ...
          posuere ac neque id volutpat. In varius dignissim posuere.
        </p>
        <p>
          Donec ut tortor eu lorem lobortis mollis non sit amet mauris. Cras molestie,
          ...
          vestibulum, urna felis pretium leo, in cursus augue metus vitae velit.
        </p>
        <p>
          Quisque condimentum sed est eu consequat. Fusce vitae urna ut diam tempus
          ...
          orci sem, tincidunt in efficitur vel, maximus sed libero.
        </p>
        <p>
          Nam mattis tristique lectus vitae vestibulum. Aenean efficitur nibh ut
        ...
        <p>
          Sed feugiat sem rutrum arcu blandit, vitae malesuada dui vehicula. Aenean
          ...
          sapien et enim fermentum imperdiet. Ut ullamcorper a nulla vel ullamcorper.
        </p>
        <p>
          Duis hendrerit sagittis sapien at pellentesque. Nunc viverra ligula eu
          ...
          consectetur vitae. In ut erat tortor.
        </p>
        <p>
          Curabitur lacinia lectus eu tortor dictum rutrum. Aliquam bibendum facilisis
          ...
          justo. Curabitur ultricies et risus a consectetur.
        </p>
        <p>
          Maecenas imperdiet est in efficitur commodo. Vestibulum eu aliquet justo.
          ...
          ornare nibh dapibus et.
        </p>
        <p>
          Quisque egestas vel neque cursus vulputate. Duis libero neque, consectetur
          ...
          ut gravida dolor interdum mattis. Vivamus ac eros quam.
        </p>
        <p>
          Integer porta tellus vel magna placerat placerat. Fusce a purus euismod,
          ...
          condimentum mauris imperdiet dictum.
        </p>
        <p>
          Etiam placerat purus eget metus porttitor, nec vehicula velit accumsan.
          ...
          tristique ultricies velit quis pellentesque.
        </p>
      </smart-splitter-item>
      <smart-splitter-item size="25%">
        <h2>Why do we use it?</h2>
        <p>
