  ...
  <div class="smart-demo-container">
    <section>
      <div class="module">
        ...
        <p>The repeat button can simply trigger an action multiple times depending on the time interval applied.</p>
      </div>
      <div class="module">
    ...
    <section id="repeat-button-demo">
      ...
      <div class="module">
        <div class="repeat-buttons-container">
          <smart-repeat-button id="progressUp">
            <i class="material-icons">arrow_upward</i>
          </smart-repeat-button>
          <smart-repeat-button id="progressDown">
      ...
      <div class="module">
        <div class="progress-bar-container">
          <smart-progress-bar
            ...
            value="5"
          ></smart-progress-bar>
          <smart-circular-progress-bar id="progressBarCircular" show-progress-value value="5"></smart-circular-progress-bar>
        </div>
      ...
      <div class="module">
        <div class="progress-bar-container">
          <smart-circular-progress-bar id="progressBarCircularControl" value="25">
            <smart-repeat-button id="incrementButton">
              <i class="material-icons">arrow_upward</i>
            </smart-repeat-button>
            <smart-repeat-button id="decrementButton">
              <i class="material-icons">arrow_downward</i>
            </smart-repeat-button>
...
.smart-demo-container #button-flat-demo .flat-demo2 {
  ...
  background-color: #eeeeee;
  text-align: center;
  background-image: url(https://htmlelements.com/demos/images/flat-button-demo.png);
...
.smart-demo-container #button-flat-demo .flat-demo2 {
  background-image: url(https://htmlelements.com/demos/images/flat-button-demo2.png);
}
...
.smart-demo-container #button-raised-demo .raised-demo2 {
  background-image: url(https://htmlelements.com/demos/images/raised-button-demo2.png);
}
...
.smart-demo-container #button-floating-demo .floating-action-area {
  background-image: url(https://htmlelements.com/demos/images/Album.png);
}
...
.smart-demo-container .floating-demo-start {
  background-image: url(https://htmlelements.com/demos/images/floating-demo-start.png);
}
...
.smart-demo-container .flat-demo-start {
  background-image: url(https://htmlelements.com/demos/images/flat-demo-start.png);
}
