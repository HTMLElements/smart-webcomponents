<template>
  <div class="vue-root">
    <div class="demo-description">
      ...
      When a new row is added, removed or updated a request with CRUD data
      ...
      rows. The type of query is stored in the request's action property.
      <br />
      <br />This example uses a demo server with AlaSQL that generates SQL to
      show how a real server might use the requests sent by the Table. The
      Server-Side Table usage does not have any restrictions on the server-side
      technologies used.
    </div>
    <div id="tableContainer">
      <smart-table id="table"></smart-table>
      <smart-button id="addNewRow" class="primary" title="Add new row"
        >+</smart-button
      >
    </div>
    <br />
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://fonts.gstatic.com/s/materialicons/v52/flUhRq6tzZclQEJ-Vdg-IuiaDsNc.woff2)
    format("woff2");
}
