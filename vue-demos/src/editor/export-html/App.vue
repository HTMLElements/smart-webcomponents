  ...
  <div class="vue-root">
    <smart-editor id="editor">
      ...
      <div>
        ...
        <p>
          ...
          <img src="./../../../src/images/Album.png" width="100" height="100" />
        </p>
      </div>
      <br />
      <div>
    ...
    <div class="options">
      <div class="demo-description">
        Editor's content can be Printed or exported to HTML file via the
  ...
  setup() {
    onMounted(() => {
      ...
      document
        ...
        .addEventListener("click", () => editor.exportData("pdf"));
      document
        .getElementById("exportToHTML")
        .addEventListener("click", () => editor.exportData("html"));
      document
        .getElementById("print")
        .addEventListener("click", () => editor.print());
    });
  },
};
</script>
