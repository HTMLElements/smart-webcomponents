<template>
  <div class="vue-root">
    ...
    <div class="options">
      ...
      <div class="option">
        <smart-radio-button>EN</smart-radio-button>
        <smart-radio-button checked>DE</smart-radio-button>
        <smart-radio-button>IT</smart-radio-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  setup() {
    onMounted(() => {
          ...
          get properties() {
            return {
              ...
              messages: {
                en: {
                  invalidValue:
                    "{{elementType}}: Invalid {{property}} value. {{property}} should be of type {{typeOne}} or {{typeTwo}}.",
                  incorrectArgument:
                    "{{elementType}}: Incorrect argument {{argumentName}} in method {{methodName}}.",
                  permissionsRequired:
                    "{{elementType}}: Permissions are required for the following action {{actionName}}.",
                  ok: "Ok",
                  cancel: "Cancel",
                  ...
                  browse: "Browse",
                  connectionError:
                    "{{elementType}}: File Upload requires connection to the server.",
                  wrongItemIndex:
                    "{{elementType}}: There is no file with such an index in the list of uploaded files.",
                  ...
                  iframeTitle:
                    "Editor Content is Encloused in it's own DOM inside an iFrame",
                ...
                de: {
                  invalidValue:
                    "{{elementType}}: Ungültiger {{property}} Wert. {{property}} sollte vom Typ {{typeOne}} oder {{typeTwo}} sein.",
                  incorrectArgument:
                    "{{elementType}}: Falsches Argument {{argumentName}} in Methode {{methodName}}.",
                  permissionsRequired:
                    "{{elementType}}: Für die folgende Aktion {{actionName}} sind Berechtigungen erforderlich.",
                  ok: "Ok",
                  cancel: "Stornieren",
                  ...
                  browse: "Durchsuche",
                  connectionError:
                    "{{elementType}}: Für das Hochladen von Dateien ist eine Verbindung zum Server erforderlich.",
                  wrongItemIndex:
                    "{{elementType}}: Die Liste der hochgeladenen Dateien enthält keine Datei mit einem solchen Index.",
                  tooLongFileName:
                    "{{elementType}}: Der Dateiname ist zu lang.",
                  ...
                  iframeTitle:
                    "Der Inhalt des Editors befindet sich in einem eigenen DOM in einem iFrame",
                ...
                it: {
                  invalidValue:
                    "{{elementType}}: valore {{property}} non valido. {{property}} deve essere di tipo {{typeOne}} o {{typeTwo}}.",
                  incorrectArgument:
                    "{{elementType}}: argomento {{topicName}} non corretto nel metodo {{methodName}}.",
                  permissionsRequired:
                    "{{elementType}}: sono necessarie autorizzazioni per la seguente azione {{actionName}}.",
                  ok: "Ok",
                  cancel: "Annulla",
                  ...
                  browse: "Navigare",
                  connectionError:
                    "{{elementType}}: il caricamento del file richiede la connessione al server.",
                  wrongItemIndex:
                    "{{elementType}}: non è presente alcun file con tale indice nell'elenco dei file caricati.",
                  tooLongFileName:
                    "{{elementType}}: il nome del file è troppo lungo.",
                  ...
                  tablevalign:
                    "Allineamento verticale delle celle della tabella",
                  ...
                  iframeTitle:
                    "Il contenuto dell'editor è racchiuso nel proprio DOM all'interno di un iFrame",
      ...
      editor.value = getEditorValue(editor.locale);
      document
        .querySelector(".options")
        .addEventListener("change", function (event) {
          editor.value = getEditorValue( editor.locale =
            event.target.innerHTML.trim().toLowerCase()
          );
        });
