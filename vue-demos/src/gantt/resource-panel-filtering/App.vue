<template>
  <div class="vue-root">
    <div id="description">
      <p>
        <b>Description:</b> The following demo displays a Company Acqusition process
        ...
        change the Resource Timeline view.
      </p>
    </div>
      ...
      <div class="custom-resource-panel-header">
        <div class="treeHeader">
          ...
          <smart-drop-down-list id="resourceFilter" drop-down-append-to="body">
            ...
            <smart-list-item value="outsource">External Company</smart-list-item>
          </smart-drop-down-list>
        </div>
        <div class="timelineHeader">
          <smart-radio-button checked value="hours">Hours per week</smart-radio-button>
