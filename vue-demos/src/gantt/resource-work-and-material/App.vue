  ...
  <div class="vue-root">
    <div class="demo-description">
      <p>
        ...
        have a custom appearance for their
        <b>resource</b> column.
        ...
        <br />Saturdays and Sundays are nonworking days and
        <b>snapToNearest</b> is enabled,
            ...
            return {
              ...
              taskColumns: [
                ...
                },
                {
                  ...
                  formatFunction: function(data, taskIndex) {
                    ...
                    if (data.length === 1) {
                      return `<span>${
                        getResource(data[0]).label.split(",")[0]
                      }</span>`;
                    } else {
                      let result = "";
                ...
                },
                {
                  ...
                  formatFunction: (data, index) => {
                    ...
                    if (resource) {
                      ...
                      const assignedTasks = ganttChart.getResourceTasks(
                        resource
                      );
                      let allocated = 0;
              ...
              timelineHeaderFormatFunction: function(date, type) {
                ...
                if (type === "week") {
                  ...
                  return (
                    startDayOfWeek.toLocaleDateString(ganttChart.locale, {
                      day: "numeric",
