<template>
  <div class="vue-root">
    <p>
      Resource Timeline View can display different information depending on
      the
      <b>resourceTimelineView</b> property:
    </p>
    <smart-gantt-chart id="ganttChart"></smart-gantt-chart>
    <div class="options">
      <div class="option">
        <h3>Resource Timeline View:</h3>
        <smart-radio-button checked>hours</smart-radio-button>
        <smart-radio-button>tasks</smart-radio-button>
        <smart-radio-button>custom</smart-radio-button>
      </div>
      <div class="option">
        <h3>Description</h3>
        <ul>
          <li>
            <b>hours</b> - the hours of a resource assigned to a task, where the resource
            attribute
            <b>capacity</b> represents the working capacity of the resource
            and
            <b>maxCapacity</b> represents the maximum capacity.
          </li>
          <li>
            <b>tasks</b> - the tasks that are assigned to the resource. In this mode
            <b>capacity</b> is
            not taken into considuration. Only
            <b>maxCapacity</b> is used to determine
            the maximum possible tasks that should be assigned to the resource.
          </li>
          <li>
            <b>custom</b> - allows to customize the cell content of the histogram since
            that's the
            <b>resourceTimelineMode</b>. This can be achieved via the
            <b>resourceTimelineFormatFunction</b> property
    ...
    onMounted(() => {
        ...
        class {
          get properties() {
            return {
              ...
              view: "week",
              resourceTimelineFormatFunction: function(
                taskIndexes,
                resourceIndex,
                cellDate
              ) {
      ...
      document
        ...
        .addEventListener("change", function(event) {
          ganttChart.resourceTimelineView = event.target.textContent.trim();
        });
    });
  }
};
