<template>
  <div class="vue-root">
    ...
    >
      ...
      <smart-list-item value="Albania">Albania</smart-list-item>
    ...
    <div class="options">
      <div class="caption">TextBox's autoComplete modes:</div>
      <div class="option">
        <smart-radio-button>None</smart-radio-button>
        <br />
        <smart-radio-button>Auto</smart-radio-button>
        <br />
        <smart-radio-button>Inline</smart-radio-button>
        <br />
        <smart-radio-button checked>Manual</smart-radio-button>
      </div>
    </div>
  </div>
</template>
