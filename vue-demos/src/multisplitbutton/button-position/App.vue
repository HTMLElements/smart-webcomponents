<template>
  <div class="vue-root">
    <div id="comboBoxContainer">
      <smart-multi-split-button buttons-data-source="['Send', 'Save', 'Save As']">
      ...
      <div class="options">
        <div class="caption">Dropdown button Position</div>
        <div class="option">
          <smart-radio-button>Left</smart-radio-button>
          <smart-radio-button checked>Right</smart-radio-button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  setup() {
    onMounted(() => {
      ...
      const splitButton = document.querySelector("smart-multi-split-button");
      radioButtons[0].addEventListener("change", function() {
        splitButton.dropDownButtonPosition = "left";
      });
      radioButtons[1].addEventListener("change", function() {
        splitButton.dropDownButtonPosition = "right";
      });
    });
  }
};
