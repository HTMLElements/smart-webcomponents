  ...
  <div class="vue-root">
    <div class="smart-demo-container">
      <template id="templateWithButtons">
        ...
        <smart-button class="material flat">OK</smart-button>
      </template>
    </div>
        ...
        <div class="module">
          <div>
            <smart-calendar
              ...
              view-sections="['title', 'header', 'footer']"
              display-mode-view="list"
              footer-template="templateWithButtons"
            ></smart-calendar>
          </div>
          <br />
...
@media only screen and (max-width: 400px) {
  smart-time-picker.material[view="landscape"],
  smart-time-picker.material-dark[view="landscape"] {
    min-width: 96%;
    width: 96%;
  }
  smart-calendar.material[view="landscape"],
  smart-calendar.material-dark[view="landscape"] {
    min-width: 96%;
    width: 96%;
  }
}
