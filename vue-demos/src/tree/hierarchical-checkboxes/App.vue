<template>
  <div class="vue-root">
    <smart-tree id="tree" has-three-states selection-mode="checkBox">
      ...
      <smart-tree-items-group expanded selected>
        Solutions
      ...
      <smart-tree-items-group expanded disabled>
        Products
        <smart-tree-item>PC products</smart-tree-item>
        <smart-tree-item selected>Mobile products</smart-tree-item>
        <smart-tree-item selected>All products</smart-tree-item>
      </smart-tree-items-group>
      <smart-tree-items-group>
        Support
