window.initAnalytics = function () {
    ...
    window.initAnalyticsChartComponents();

    addTodayMenuOpenHandlers();
}


window.initAnalyticsChartComponents = function () {
    const devicesData = [
    ...
    const chart1 = new window.Smart.Chart('#devicesChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    const chart2 = new window.Smart.Chart('#interestsChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    const chart3 = new window.Smart.Chart('#sourceChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
