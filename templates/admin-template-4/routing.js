...
function setupRouting() {
    ...
    router.setRoutes([
        ...
        {
            path: '/dashboard-3',
            template: './dashboard-3/template.htm',
            styleUrls: ['./dashboard-3/styles.css'],
            scriptUrls: [
                '../../source/modules/smart.calendar.js',
                './dashboard-3/index.js'
            ],
        ...
        {
            path: '/e-commerce-details',
            template: './e-commerce-details/template.htm',
            styleUrls: [
                './e-commerce-details/styles.css',
                'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css'
            ],
            scriptUrls: [
                '../../source/modules/smart.radiobutton.js',
                '../../source/modules/smart.carousel.js',
                './e-commerce-details/index.js'
            ],
            title: 'E-commerce Details - ' + defaultTitle
        },
        {
            path: '/e-commerce-list',
            template: './e-commerce-list/template.htm',
            styleUrls: [
                './e-commerce-list/styles.css',
                'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css'
            ],
            scriptUrls: [
                '../../source/modules/smart.radiobutton.js',
                './e-commerce-list/index.js'
            ],
            title: 'E-commerce List - ' + defaultTitle
        },
        {
            path: '/e-commerce-checkout',
            template: './e-commerce-checkout/template.htm',
            styleUrls: [
                './e-commerce-checkout/styles.css',
                'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css'
            ],
            scriptUrls: [
                '../../source/modules/smart.radiobutton.js',
        ...
        },
        {
            ...
            scriptUrls: [
                '../../source/modules/smart.textarea.js',
                './settings/index.js'
            ],
        ...
        {
            path: '/tasks-2',
            template: './tasks-2/template.htm',
            styleUrls: ['./tasks-2/styles.css'],
            scriptUrls: [
                {src: '../../common/data.js', type: 'text/javascript'},
                '../../source/modules/smart.kanban.js',
                './tasks-2/index.js'
        ...
        {
            path: '/knowledge-base',
            template: './knowledge-base/template.htm',
            styleUrls: ['./knowledge-base/styles.css'],
            scriptUrls: [
        ...
        {
            path: '/users-list',
            template: './users-list/template.htm',
            styleUrls: [
                './users-list/styles.css'
            ],
            scriptUrls: [
                '../../source/modules/smart.progressbar.js',
                './users-list/index.js'
        ...
        },
        {
            ...
            scriptUrls: [
                '../../source/modules/smart.form.js',
                '../../source/modules/smart.textarea.js',
                '../../source/modules/smart.passwordtextbox.js',
                '../../source/modules/smart.multilinetextbox.js',
                './layouts/index.js'
            ],
        ...
        },
        {
            ...
            scriptUrls: [
                '../../source/modules/smart.form.js',
                '../../source/modules/smart.passwordtextbox.js',
                '../../source/modules/smart.textbox.js',
                '../../source/modules/smart.textarea.js',
                './validation/index.js'
            ],
