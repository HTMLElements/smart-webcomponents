window.initDefault = function () {
    const salesData = [
            ...
            {month: 'Feb', sales: 31323, orders: 8902},
            {month: 'Mar', sales: 68200, orders: 10043},
            ...
            {month: 'Nov', sales: 47542, orders: 8301},
            {month: 'Dec', sales: 39012, orders: 10632}
        ],
        weeklyData = [
    ...
    new window.Smart.Chart('#weeklySalesChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    new window.Smart.Chart('#salesComparisonChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
