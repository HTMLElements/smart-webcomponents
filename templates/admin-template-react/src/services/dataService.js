...
export function generateCarsData() {
...
export function generateGanttChartDataTree(count = 50, minDate, maxDate) {
    const data = [];
...
export function getRandom(coeff = 10) {
    return Math.round(Math.random() * coeff)
}

export function generateGanttChartDataFlat(count = 50, minDate, maxDate) {
    const data = [];
