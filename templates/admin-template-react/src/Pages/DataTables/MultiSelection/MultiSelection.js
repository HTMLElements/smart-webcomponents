...
function MultiSelection() {
    ...
    useEffect(() => { document.title = `Multi Selection - ${defaultTitle}` }, []);
    ...
    return (
        <div className="container">
            <div className="row">
                <div className="col-12 mb-3"><h4>Table With Multi Selection</h4></div>
            </div>
...
export default withAnimation(MultiSelection)