...
function KanbanTasks1() {

    useEffect(() => { document.title = `Tasks - ${defaultTitle}` }, []);
    ...
    return (
        <div className="container kanban-tasks1">
            <div className="row">
                <div className="col-12 mb-3"><h4>Tasks</h4></div>
            </div>
...
export default withAnimation(KanbanTasks1)