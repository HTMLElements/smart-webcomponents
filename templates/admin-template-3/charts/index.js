window.initCharts = function () {
    window.initChartsChartComponents();
}

window.initChartsChartComponents = function () {
    const salesData = [
    ...
    const chart1 = new window.Smart.Chart('#lineChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    const chart2 = new window.Smart.Chart('#columnChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    const chart3 = new window.Smart.Chart('#donutChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    const chart4 = new window.Smart.Chart('#pieChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    chart4.addColorScheme('custom', customColors);
    chart4.refresh();

    const chart5 = new window.Smart.Chart('#spiderChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    chart5.addColorScheme('custom', customColors);
    chart5.refresh();

    const chart6 = new window.Smart.Chart('#polarChart', {
        animation: 'none',
        theme: getTheme(),
        caption: '',
        description: '',
    ...
    chart6.addColorScheme('custom', customColors);
    chart6.refresh();
