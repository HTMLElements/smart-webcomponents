...
window.viewChanged = viewChanged;
function setupRouting() {
    ...
    router.setRoutes([
        ...
        {
            path: '/categories',
            template: './categories/template.htm',
            styleUrls: ['./common-tables.css'],
            scriptUrls: [
                './categories/index.js'
            ],
            title: defaultTitle
        ...
        {
            path: '/employees',
            template: './employees/template.htm',
            styleUrls: ['./common-tables.css', './employees/styles.css'],
            scriptUrls: [
                './employees/index.js'
            ],
            title: defaultTitle
        ...
        {
            path: '/order-details',
            template: './order-details/template.htm',
            styleUrls: ['./common-tables.css'],
            scriptUrls: [
                './order-details/index.js'
            ],
            title: defaultTitle
        },
        {
            path: '/suppliers',
            template: './suppliers/template.htm',
            styleUrls: ['./common-tables.css'],
            scriptUrls: [
                './suppliers/index.js'
            ],
        ...
        {
            path: '/profile',
            template: './profile/template.htm',
            styleUrls: [
                './social/styles.css',
                './profile/styles.css'
            ],
            scriptUrls: ['./profile/index.js'],
        ...
        },
        {
            ...
            title: 'Projects List - ' + defaultTitle
        },
        {
            path: '/detail',
        ...
        },
        {
            ...
            scriptUrls: [
                'https://cdnjs.cloudflare.com/ajax/libs/jqwidgets/10.1.5/jqwidgets/smart-all.min.js',
                './editor/index.js'
            ],
